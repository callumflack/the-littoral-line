...
**I’ve finally managed to fully replicate the Jekyll paradigm using Vue.js on my personal website.** I was previously using [Nuxt.js](https://nuxtjs.org/) (which I use for most of my client projects) but I think blogging needs to be much lighter. [Vuepress](https://vuepress.vuejs.org/) and [Gridsome](https://gridsome.org) aren’t quite laser-focused on markdown—the essential writing file format in my opinion—or aren't quite "blog aware" enough. I was frustrated for some months until I stumbled across the excellent [Saber](https://saber.land) framework. So now [my site](https://www.callumflack.design/) is now exactly I’d wished: just a folder of markdown files with a Vue.js presentation layer. The repo is [open-sourced here](https://github.com/callumflack/callum-flack-design) in all it's 18 branches of graceless ageing.
